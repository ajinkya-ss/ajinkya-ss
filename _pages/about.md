...
Welcome! I am **Ajinkya Shingote**, a Ph.D. student in **Chemistry** at the [Department of Chem](https://acms.nd.edu/), **University of Notre Dame**, IN, USA.

I am currently working under the supervision of [Dr. abc](https://acms.nd.edu/people/), focusing on developing neural network algorithms for higher-dimensional problems.

Previously, I completed my **M.Sc. in Chemistry** at the [Indian Institute of Science Education and Research (IISER) Pune](https://www.iiserpune.ac.in/), Maharashtra, India, where I worked on my master’s project under the guidance of [Dr. Anshuman nag](https://www.iiserpune.ac.in/).
